...
const FailedTask = ({ data }) => {
    return (
        <div className='flex-shrink-0 h-full p-5 w-full max-w-xs bg-[#edd224] rounded-xl'>
            ...
            <div className='mt-4'>
                <button className='bg-red-600 p-2 font-medium text-xs md:text-sm rounded w-full'>
                    Failed
                </button>
            </div>
        </div>
