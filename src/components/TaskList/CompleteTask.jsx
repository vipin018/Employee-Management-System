...
const CompleteTask = ({data}) => {
  return (
    <div className=' flex-shrink-0 h-full p-5 w-[350px] bg-[#ed2461] rounded-xl'>
                ...
                <div className='mt-4 '>
    <button className='bg-lime-600 p-2 font-medium text-sm rounded w-full' >Completed</button>
